...
def stm32HeaterBlk(pout, port, pin, channel, rng, single):
    """

    Call:   stm32HeaterBlk(pout, port, pin, channel)
    ...
    blk = RCPblk('stm32Heater', [], pout, [0,0], 0, [0], [pn, pin, channel, rng, single])
    return blk
