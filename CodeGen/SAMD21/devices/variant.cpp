 ...
 * | 17         | 17               |  PB02  | A6              | EIC/EXTINT[2]   ADC/AIN[10]          PTC/Y[8]                  SERCOM5/PAD[0]
 * | 18         | 18               |  PB03  | A7              | EIC/EXTINT[3]   ADC/AIN[11]          PTC/Y[9]                  SERCOM5/PAD[1]
 * | 19         | 19               |  PB08  | A8              | EIC/EXTINT[8]   ADC/AIN[2]           PTC/Y[14]                 SERCOM4/PAD[0]  *TC4/WO[0]
 * | 20         | 20               |  PB09  | A9              | EIC/EXTINT[9]   ADC/AIN[3]           PTC/Y[15]                 SERCOM4/PAD[1]  *TC4/WO[1]
...
const PinDescription g_APinDescription[]=
{
	...
	{ PORTA, 10, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM1_CH0, TCC0_CH2, EXTERNAL_INT_10 },	//
	{ PORTA, 9, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM0_CH1, TCC1_CH3, EXTERNAL_INT_9 },		// EXT_I2C_SCL: SERCOM0/PAD[1]
	{ PORTA, 8, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM0_CH0, TCC1_CH2, EXTERNAL_INT_NMI },	// EXT_I2C_SDA: SERCOM0/PAD[0]
	...
	{ PORTA, 11, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM1_CH1, TCC0_CH3, EXTERNAL_INT_NONE },	// MISO: SERCOM2/PAD[3]
	
	// 26..31 - Analog pins - pins shared with ABC SAM - Analogici anticipati per compatibilità con FIRMATA
	...
	// 52..64 - ESP analog pins
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A10 - ESP GPIO2
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A11 - ESP GPIO4
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A12 - ESP GPIO7
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A13 - ESP GPIO8
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A14 - ESP GPIO0
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A15 - ESP GPIO1
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A16 - ESP GPIO3
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A17 - ESP GPIO9
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A18 - ESP GPIO10
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A19 - ESP GPIO32
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A20 - ESP GPIO33
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A21 - ESP GPIO34
	{ NOT_A_PORT, 0, PIO_EXTERNAL, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // A22 - ESP GPIO35
...
Uart SerialEsp(&sercom5, PIN_SERIAL2_RX, PIN_SERIAL2_TX, PAD_SERIAL2_RX, PAD_SERIAL2_TX);
