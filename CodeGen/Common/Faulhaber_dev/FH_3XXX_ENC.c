...
static uint8_t read_req[8] = {0x40, 0x64, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00};
...
static void inout(python_block *block)
{
  ...
  y[0] = 1.0*getValue(0x580+block->intPar[0], 0x6064, 0x00)/(block->realPar[0]);
}
...
void FH_3XXX_ENC(int Flag, python_block *block)
{
